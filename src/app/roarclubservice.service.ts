...
insert_bank_information(data){
  return this.https.post(this.baseUrl + "associates/insert_bank_information", data);

}
update_bank_information(data){
  return this.https.post(this.baseUrl + "associates/update_bank_information", data);
...
return this.https.post(this.baseUrl + "associates/add_customer_registration", data);

}
referral_details(data) {
return this.https.post(this.baseUrl + "associates/referral_details", data);
}
otpVerificationUserReferral(data) {
return this.https.post(this.baseUrl + "associates/otpVerificationReferral", data);
}
sendOtpVerifyReferral(data) {
return this.https.post(this.baseUrl + "associates/sendOtpVerifyReferral", data);
}
update_customer_registration(data){
return this.https.post(this.baseUrl + "associates/update_customer_registration", data);
